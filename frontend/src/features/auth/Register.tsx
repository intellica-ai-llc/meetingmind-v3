...
export function Register() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // Throws only on network/configuration error, not after redirect
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-meetingmind-bg flex items-center justify-center p-4">
      <div className="bg-meetingmind-card rounded-xl p-8 w-full max-w-md border border-meetingmind-gold/30">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-2 px-4 bg-white text-gray-800 font-semibold rounded-lg hover:bg-gray-100 transition flex items-center justify-center gap-2 disabled:opacity-50"
        >
        ...
        <p className="text-center text-gray-500 text-xs mt-6">
          MeetingMind uses Google to create your account securely.
        </p>
