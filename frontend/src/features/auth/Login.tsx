      ...
      <div className="bg-meetingmind-card rounded-xl p-8 w-full max-w-md border border-meetingmind-gold/30">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-meetingmind-card text-gray-400">or continue with email</span>
          </div>
        </div>
        ...
        <p className="text-center text-gray-400 mt-4">
          Don't have an account? <Link to="/register" className="text-meetingmind-gold hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  )
